    ...
    if sig.signal == "BUY" and sizing.get("viable"):
        ...
        if net < 0:
            parts.append(
                ...
                f"<b>{money(net)} per trade</b>. Backtesting over ~1,400 trades put the gross edge at "
...
<footer class="page">
  ...
  Backtested over ~1,400 trades (2012–2026) with 2021 onward held out: the strategy carries a
