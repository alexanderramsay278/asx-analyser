...
def test_breakeven_matches_published_figure():
    """The ~$14k floor quoted in the README."""
    assert strategy.breakeven_position_size() == pytest.approx(14_286, rel=0.01)
...
def test_expected_value_is_negative_at_small_size():
    ...
    assert strategy.expected_net_per_trade(2_951) == pytest.approx(-15.87, abs=0.5)
